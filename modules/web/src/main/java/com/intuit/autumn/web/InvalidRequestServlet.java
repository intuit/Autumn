...
/**
 * Default response implementation supporting invalid requests.
 */

public class InvalidRequestServlet extends HttpServlet {

    /**
     * Invalid response service.
     *
    ...
    protected void service(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
        ...
        httpServletResponse.setContentType(UTF_8.name());
        httpServletResponse.getWriter().append(Integer.toString(SC_NOT_FOUND));
    }
}
