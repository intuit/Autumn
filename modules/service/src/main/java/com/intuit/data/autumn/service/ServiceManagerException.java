...
/**
 * Holder for ServiceManager exceptions.
 */
...
public class ServiceManagerException extends Exception {
    ...
    protected ServiceManagerException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
