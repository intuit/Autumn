...
public class HttpCallImplTest extends TestCase {

    private int port = 9876;
    @Rule
    public WireMockRule wireMockRule = new WireMockRule(port);
    private HttpCallImpl<ClientResponse> httpCallsImpl;
    ...
    @Before
    public void before() {
        httpCallsImpl = new HttpCallImpl<>();
